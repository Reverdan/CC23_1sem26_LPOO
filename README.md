...
- [AULA1](AULA1.md) — Projeto introdutório com interface gráfica, cálculos e validações. Apresenta estrutura básica de pacotes, uso de Swing e primeiros conceitos de O.O.
- [PRIMO](PRIMO.md) — Projeto que verifica se um número é primo, introduzindo herança simples e separação de responsabilidades, com arquitetura MVC e Facade.
- [TRIANGULOS](TRIANGULOS.md) — Projeto avançado de validação e classificação de triângulos, aplicando interface, classe abstrata, polimorfismo, padrões Facade, MVC, Template Method e princípios SOLID.
